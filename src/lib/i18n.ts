...
export const translations = {
  fr: {
    ...
    questions: {
      ...
      niveau_etudes: "Quel est votre niveau d'études le plus élevé ?",
    ...
    options: {
      ...
      niveau_poste: {
        ...
        charge_mission: "Chargé·e de mission / Chef·fe de projet",
        manager_proximite: "Manager de proximité / Team lead",
        manager_intermediaire: "Manager intermédiaire / Responsable de département",
        directeur: "Directeur·rice / Cadre dirigeant",
        dirigeant: "Dirigeant·e / CEO / Fondateur·rice",
      ...
      niveau_etudes: {
        bac_ou_moins: "Bac ou inférieur",
        bac_plus_2: "Bac +2 (BTS, DUT, DEUG)",
        bac_plus_3: "Bac +3 (Licence, Bachelor)",
        bac_plus_5: "Bac +5 (Master, École d'ingénieur, École de commerce)",
        doctorat: "Doctorat (PhD)",
        autre_formation: "Formation professionnelle / Autre",
      },
      usage_ia: {
  ...
  en: {
    ...
    questions: {
      ...
      niveau_etudes: "What is your highest level of education?",
    ...
    options: {
      ...
      niveau_poste: {
        stagiaire_alternant: "Intern / Apprentice",
        employe: "Employee / Technician",
        charge_mission: "Project manager / Mission lead",
        manager_proximite: "Team lead / First-line manager",
        manager_intermediaire: "Middle manager / Department head",
        directeur: "Director / Senior executive",
        dirigeant: "CEO / Founder / Owner",
      ...
      niveau_etudes: {
        bac_ou_moins: "High school or below",
        bac_plus_2: "Associate degree (2 years post-secondary)",
        bac_plus_3: "Bachelor's degree",
        bac_plus_5: "Master's degree / Business school / Engineering school",
        doctorat: "Doctorate (PhD)",
        autre_formation: "Professional training / Other",
      },
      usage_ia: {
